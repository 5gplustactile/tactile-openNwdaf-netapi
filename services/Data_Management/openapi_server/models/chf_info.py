...
class ChfInfo(Model):
    ...
    def __init__(self, supi_range_list=None, gpsi_range_list=None, plmn_range_list=None, group_id=None, primary_chf_instance=None, secondary_chf_instance=None):  # noqa: E501
        ...
        :type group_id: str
        :param primary_chf_instance: The primary_chf_instance of this ChfInfo.  # noqa: E501
        :type primary_chf_instance: str
        :param secondary_chf_instance: The secondary_chf_instance of this ChfInfo.  # noqa: E501
    ...
    def primary_chf_instance(self):
        """Gets the primary_chf_instance of this ChfInfo.
        ...
        :return: The primary_chf_instance of this ChfInfo.
        :rtype: str
        """
    ...
    def primary_chf_instance(self, primary_chf_instance):
        """Sets the primary_chf_instance of this ChfInfo.

        String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.    # noqa: E501

        :param primary_chf_instance: The primary_chf_instance of this ChfInfo.
        :type primary_chf_instance: str
        """
    ...
    def secondary_chf_instance(self):
        """Gets the secondary_chf_instance of this ChfInfo.

        String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.    # noqa: E501

        :return: The secondary_chf_instance of this ChfInfo.
        :rtype: str
        """
    ...
    def secondary_chf_instance(self, secondary_chf_instance):
        """Sets the secondary_chf_instance of this ChfInfo.

        String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.    # noqa: E501

        :param secondary_chf_instance: The secondary_chf_instance of this ChfInfo.
        :type secondary_chf_instance: str
        """
