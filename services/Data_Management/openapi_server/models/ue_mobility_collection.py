...
class UeMobilityCollection(Model):
    ...
    def __init__(self, gpsi=None, supi=None, app_id=None, all_app_ind=None, ue_trajs=None):  # noqa: E501
        ...
        :type app_id: str
        :param all_app_ind: The all_app_ind of this UeMobilityCollection.  # noqa: E501
        :type all_app_ind: bool
    ...
    @property
    def all_app_ind(self):
        """Gets the all_app_ind of this UeMobilityCollection.

        Indicates applicable to all applications if set to true, otherwise set to false.  Default value is false if omitted.   # noqa: E501

        :return: The all_app_ind of this UeMobilityCollection.
        :rtype: bool
        """
        return self._all_app_ind

    @all_app_ind.setter
    def all_app_ind(self, all_app_ind):
        """Sets the all_app_ind of this UeMobilityCollection.

        Indicates applicable to all applications if set to true, otherwise set to false.  Default value is false if omitted.   # noqa: E501

        :param all_app_ind: The all_app_ind of this UeMobilityCollection.
        :type all_app_ind: bool
        """
