...
class NefInfo(Model):
    ...
    def __init__(self, nef_id=None, pfd_data=None, af_ee_data=None, gpsi_ranges=None, external_group_identifiers_ranges=None, served_fqdn_list=None, tai_list=None, tai_range_list=None, dnai_list=None, un_trust_af_info_list=None, uas_nf_functionality_ind=False):  # noqa: E501
        ...
        :param tai_list: The tai_list of this NefInfo.  # noqa: E501
        :type tai_list: List[Tai]
        :param tai_range_list: The tai_range_list of this NefInfo.  # noqa: E501
        :type tai_range_list: List[TaiRange]
        :param dnai_list: The dnai_list of this NefInfo.  # noqa: E501
        :type dnai_list: List[str]
        :param un_trust_af_info_list: The un_trust_af_info_list of this NefInfo.  # noqa: E501
        :type un_trust_af_info_list: List[UnTrustAfInfo]
        :param uas_nf_functionality_ind: The uas_nf_functionality_ind of this NefInfo.  # noqa: E501
    ...
    @property
    def tai_list(self):
        """Gets the tai_list of this NefInfo.


        :return: The tai_list of this NefInfo.
        :rtype: List[Tai]
        """
    ...
    def tai_list(self, tai_list):
        """Sets the tai_list of this NefInfo.


        :param tai_list: The tai_list of this NefInfo.
        :type tai_list: List[Tai]
        """
    ...
    def tai_range_list(self):
        """Gets the tai_range_list of this NefInfo.


        :return: The tai_range_list of this NefInfo.
        :rtype: List[TaiRange]
        """
    ...
    def tai_range_list(self, tai_range_list):
        """Sets the tai_range_list of this NefInfo.


        :param tai_range_list: The tai_range_list of this NefInfo.
        :type tai_range_list: List[TaiRange]
        """
    ...
    @property
    def dnai_list(self):
        """Gets the dnai_list of this NefInfo.


        :return: The dnai_list of this NefInfo.
        :rtype: List[str]
        """
    ...
    def dnai_list(self, dnai_list):
        """Sets the dnai_list of this NefInfo.


        :param dnai_list: The dnai_list of this NefInfo.
        :type dnai_list: List[str]
        """
    ...
    def un_trust_af_info_list(self):
        """Gets the un_trust_af_info_list of this NefInfo.


        :return: The un_trust_af_info_list of this NefInfo.
    ...
    def un_trust_af_info_list(self, un_trust_af_info_list):
        """Sets the un_trust_af_info_list of this NefInfo.


        :param un_trust_af_info_list: The un_trust_af_info_list of this NefInfo.
        :type un_trust_af_info_list: List[UnTrustAfInfo]
        """
    ...
    def uas_nf_functionality_ind(self):
        """Gets the uas_nf_functionality_ind of this NefInfo.


        :return: The uas_nf_functionality_ind of this NefInfo.
        :rtype: bool
        """
    ...
    def uas_nf_functionality_ind(self, uas_nf_functionality_ind):
        """Sets the uas_nf_functionality_ind of this NefInfo.


        :param uas_nf_functionality_ind: The uas_nf_functionality_ind of this NefInfo.
        :type uas_nf_functionality_ind: bool
        """
