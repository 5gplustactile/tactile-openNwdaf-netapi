...
class NwdafInfo(Model):
    ...
    def __init__(self, event_ids=None, nwdaf_events=None, tai_list=None, tai_range_list=None, nwdaf_capability=None, analytics_delay=None, serving_nf_set_id_list=None, serving_nf_type_list=None, ml_analytics_list=None):  # noqa: E501
        ...
        :param nwdaf_capability: The nwdaf_capability of this NwdafInfo.  # noqa: E501
        :type nwdaf_capability: NwdafCapability
        :param analytics_delay: The analytics_delay of this NwdafInfo.  # noqa: E501
        :type analytics_delay: int
        :param serving_nf_set_id_list: The serving_nf_set_id_list of this NwdafInfo.  # noqa: E501
        :type serving_nf_set_id_list: List[str]
        :param serving_nf_type_list: The serving_nf_type_list of this NwdafInfo.  # noqa: E501
        :type serving_nf_type_list: List[NFType]
        :param ml_analytics_list: The ml_analytics_list of this NwdafInfo.  # noqa: E501
    ...
    def nwdaf_capability(self):
        """Gets the nwdaf_capability of this NwdafInfo.


        :return: The nwdaf_capability of this NwdafInfo.
    ...
    def nwdaf_capability(self, nwdaf_capability):
        """Sets the nwdaf_capability of this NwdafInfo.


        :param nwdaf_capability: The nwdaf_capability of this NwdafInfo.
        :type nwdaf_capability: NwdafCapability
        """
    ...
    def analytics_delay(self):
        """Gets the analytics_delay of this NwdafInfo.

        indicating a time in seconds.  # noqa: E501

        :return: The analytics_delay of this NwdafInfo.
        :rtype: int
        """
    ...
    def analytics_delay(self, analytics_delay):
        """Sets the analytics_delay of this NwdafInfo.

        indicating a time in seconds.  # noqa: E501

        :param analytics_delay: The analytics_delay of this NwdafInfo.
        :type analytics_delay: int
        """
    ...
    def serving_nf_set_id_list(self):
        """Gets the serving_nf_set_id_list of this NwdafInfo.


        :return: The serving_nf_set_id_list of this NwdafInfo.
        :rtype: List[str]
        """
    ...
    def serving_nf_set_id_list(self, serving_nf_set_id_list):
        """Sets the serving_nf_set_id_list of this NwdafInfo.


        :param serving_nf_set_id_list: The serving_nf_set_id_list of this NwdafInfo.
        :type serving_nf_set_id_list: List[str]
        """
    ...
    def serving_nf_type_list(self):
        """Gets the serving_nf_type_list of this NwdafInfo.


        :return: The serving_nf_type_list of this NwdafInfo.
        :rtype: List[NFType]
        """
    ...
    def serving_nf_type_list(self, serving_nf_type_list):
        """Sets the serving_nf_type_list of this NwdafInfo.


        :param serving_nf_type_list: The serving_nf_type_list of this NwdafInfo.
        :type serving_nf_type_list: List[NFType]
        """
    ...
    def ml_analytics_list(self):
        """Gets the ml_analytics_list of this NwdafInfo.


        :return: The ml_analytics_list of this NwdafInfo.
    ...
    def ml_analytics_list(self, ml_analytics_list):
        """Sets the ml_analytics_list of this NwdafInfo.


        :param ml_analytics_list: The ml_analytics_list of this NwdafInfo.
        :type ml_analytics_list: List[MlAnalyticsInfo]
        """
