...
class AmfEventSubscription(Model):
    ...
    def __init__(self, event_list=None, event_notify_uri=None, notify_correlation_id=None, nf_id=None, subs_change_notify_uri=None, subs_change_notify_correlation_id=None, supi=None, group_id=None, exclude_supi_list=None, exclude_gpsi_list=None, include_supi_list=None, include_gpsi_list=None, gpsi=None, pei=None, any_ue=None, options=None, source_nf_type=None, term_notify_ind=None):  # noqa: E501
    ...
    def term_notify_ind(self, term_notify_ind):
