...
class NsiLoadLevelInfo(Model):
    ...
    def __init__(self, load_level_information=None, snssai=None, nsi_id=None, res_usage=None, num_of_exceed_load_level_thr=None, exceed_load_level_thr_ind=None, network_area=None, time_period=None, res_usg_thr_cross_time_period=None, num_of_ues=None, num_of_pdu_sess=None, confidence=None):  # noqa: E501
        ...
        :param res_usg_thr_cross_time_period: The res_usg_thr_cross_time_period of this NsiLoadLevelInfo.  # noqa: E501
        :type res_usg_thr_cross_time_period: List[TimeWindow]
        ...
        self.openapi_types = {
            ...
            'res_usg_thr_cross_time_period': List[TimeWindow],
        ...
        self.attribute_map = {
            ...
            'res_usg_thr_cross_time_period': 'resUsgThrCrossTimePeriod',
            'num_of_ues': 'numOfUes',
        ...
        self._res_usg_thr_cross_time_period = res_usg_thr_cross_time_period
    ...
    @property
    def res_usg_thr_cross_time_period(self):
        """Gets the res_usg_thr_cross_time_period of this NsiLoadLevelInfo.

        Each element indicates the time elapsed between times each threshold is met or exceeded or crossed. The start time and end time are the exact time stamps of the resource usage threshold is reached or exceeded. May be present if the \"listOfAnaSubsets\" attribute is  provided and the maximum number of instances shall not exceed the value provided in the  \"numOfExceedLoadLevelThr\" attribute.   # noqa: E501

        :return: The res_usg_thr_cross_time_period of this NsiLoadLevelInfo.
        :rtype: List[TimeWindow]
        """
        return self._res_usg_thr_cross_time_period

    @res_usg_thr_cross_time_period.setter
    def res_usg_thr_cross_time_period(self, res_usg_thr_cross_time_period):
        """Sets the res_usg_thr_cross_time_period of this NsiLoadLevelInfo.

        Each element indicates the time elapsed between times each threshold is met or exceeded or crossed. The start time and end time are the exact time stamps of the resource usage threshold is reached or exceeded. May be present if the \"listOfAnaSubsets\" attribute is  provided and the maximum number of instances shall not exceed the value provided in the  \"numOfExceedLoadLevelThr\" attribute.   # noqa: E501

        :param res_usg_thr_cross_time_period: The res_usg_thr_cross_time_period of this NsiLoadLevelInfo.
        :type res_usg_thr_cross_time_period: List[TimeWindow]
        """
        if res_usg_thr_cross_time_period is not None and len(res_usg_thr_cross_time_period) < 1:
            raise ValueError("Invalid value for `res_usg_thr_cross_time_period`, number of items must be greater than or equal to `1`")  # noqa: E501
