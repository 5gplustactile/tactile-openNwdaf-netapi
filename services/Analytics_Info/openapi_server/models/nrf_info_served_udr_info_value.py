...
class NrfInfoServedUdrInfoValue(Model):
    ...
    def __init__(self, group_id=None, supi_ranges=None, gpsi_ranges=None, external_group_identifiers_ranges=None, supported_data_sets=None, shared_data_id_ranges=None):  # noqa: E501
        """NrfInfoServedUdrInfoValue - a model defined in OpenAPI

        :param group_id: The group_id of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :type group_id: str
        :param supi_ranges: The supi_ranges of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :type supi_ranges: List[SupiRange]
        :param gpsi_ranges: The gpsi_ranges of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :type gpsi_ranges: List[IdentityRange]
        :param external_group_identifiers_ranges: The external_group_identifiers_ranges of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :type external_group_identifiers_ranges: List[IdentityRange]
        :param supported_data_sets: The supported_data_sets of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :type supported_data_sets: List[DataSetId]
        :param shared_data_id_ranges: The shared_data_id_ranges of this NrfInfoServedUdrInfoValue.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'NrfInfoServedUdrInfoValue':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The NrfInfo_servedUdrInfo_value of this NrfInfoServedUdrInfoValue.  # noqa: E501
        :rtype: NrfInfoServedUdrInfoValue
        """
        return util.deserialize_model(dikt, cls)

    @property
    def group_id(self):
        """Gets the group_id of this NrfInfoServedUdrInfoValue.

        Identifier of a group of NFs.  # noqa: E501

        :return: The group_id of this NrfInfoServedUdrInfoValue.
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this NrfInfoServedUdrInfoValue.

        Identifier of a group of NFs.  # noqa: E501

        :param group_id: The group_id of this NrfInfoServedUdrInfoValue.
        :type group_id: str
        """
    ...
    def supi_ranges(self):
        """Gets the supi_ranges of this NrfInfoServedUdrInfoValue.


        :return: The supi_ranges of this NrfInfoServedUdrInfoValue.
    ...
    def supi_ranges(self, supi_ranges):
        """Sets the supi_ranges of this NrfInfoServedUdrInfoValue.


        :param supi_ranges: The supi_ranges of this NrfInfoServedUdrInfoValue.
        :type supi_ranges: List[SupiRange]
        """
    ...
    def gpsi_ranges(self):
        """Gets the gpsi_ranges of this NrfInfoServedUdrInfoValue.


        :return: The gpsi_ranges of this NrfInfoServedUdrInfoValue.
    ...
    def gpsi_ranges(self, gpsi_ranges):
        """Sets the gpsi_ranges of this NrfInfoServedUdrInfoValue.


        :param gpsi_ranges: The gpsi_ranges of this NrfInfoServedUdrInfoValue.
        :type gpsi_ranges: List[IdentityRange]
        """
    ...
    def external_group_identifiers_ranges(self):
        """Gets the external_group_identifiers_ranges of this NrfInfoServedUdrInfoValue.


        :return: The external_group_identifiers_ranges of this NrfInfoServedUdrInfoValue.
        :rtype: List[IdentityRange]
        """
    ...
    def external_group_identifiers_ranges(self, external_group_identifiers_ranges):
        """Sets the external_group_identifiers_ranges of this NrfInfoServedUdrInfoValue.


        :param external_group_identifiers_ranges: The external_group_identifiers_ranges of this NrfInfoServedUdrInfoValue.
        :type external_group_identifiers_ranges: List[IdentityRange]
        """
    ...
    def supported_data_sets(self):
        """Gets the supported_data_sets of this NrfInfoServedUdrInfoValue.


        :return: The supported_data_sets of this NrfInfoServedUdrInfoValue.
    ...
    def supported_data_sets(self, supported_data_sets):
        """Sets the supported_data_sets of this NrfInfoServedUdrInfoValue.


        :param supported_data_sets: The supported_data_sets of this NrfInfoServedUdrInfoValue.
        :type supported_data_sets: List[DataSetId]
        """
    ...
    def shared_data_id_ranges(self):
        """Gets the shared_data_id_ranges of this NrfInfoServedUdrInfoValue.


        :return: The shared_data_id_ranges of this NrfInfoServedUdrInfoValue.
    ...
    def shared_data_id_ranges(self, shared_data_id_ranges):
        """Sets the shared_data_id_ranges of this NrfInfoServedUdrInfoValue.


        :param shared_data_id_ranges: The shared_data_id_ranges of this NrfInfoServedUdrInfoValue.
        :type shared_data_id_ranges: List[SharedDataIdRange]
        """
