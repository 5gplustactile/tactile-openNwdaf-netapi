...
class EndpointAddress(Model):
    ...
    def __init__(self, ipv4_addr=None, ipv6_addr=None, port_number=None):  # noqa: E501
        """EndpointAddress - a model defined in OpenAPI

        :param ipv4_addr: The ipv4_addr of this EndpointAddress.  # noqa: E501
        :type ipv4_addr: str
        :param ipv6_addr: The ipv6_addr of this EndpointAddress.  # noqa: E501
        :type ipv6_addr: Ipv6Addr
        :param port_number: The port_number of this EndpointAddress.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'EndpointAddress':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The EndpointAddress of this EndpointAddress.  # noqa: E501
    ...
    def ipv4_addr(self, ipv4_addr):
        """Sets the ipv4_addr of this EndpointAddress.

        String identifying a IPv4 address formatted in the 'dotted decimal' notation as defined in RFC 1166.   # noqa: E501

        :param ipv4_addr: The ipv4_addr of this EndpointAddress.
        :type ipv4_addr: str
        """
    ...
    @property
    def ipv6_addr(self):
        """Gets the ipv6_addr of this EndpointAddress.


        :return: The ipv6_addr of this EndpointAddress.
        :rtype: Ipv6Addr
        """
    ...
    def ipv6_addr(self, ipv6_addr):
        """Sets the ipv6_addr of this EndpointAddress.


        :param ipv6_addr: The ipv6_addr of this EndpointAddress.
        :type ipv6_addr: Ipv6Addr
        """
    ...
    def port_number(self, port_number):
        """Sets the port_number of this EndpointAddress.

        Integer where the allowed values correspond to the value range of an unsigned 16-bit integer.  # noqa: E501

        :param port_number: The port_number of this EndpointAddress.
        :type port_number: int
        """
        if port_number is None:
            raise ValueError("Invalid value for `port_number`, must not be `None`")  # noqa: E501
        if port_number is not None and port_number > 65535:  # noqa: E501
