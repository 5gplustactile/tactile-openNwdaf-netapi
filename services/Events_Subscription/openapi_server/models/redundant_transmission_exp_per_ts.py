...
from openapi_server.models.observed_redundant_trans_exp import ObservedRedundantTransExp  # noqa: E501
...
class RedundantTransmissionExpPerTS(Model):
    ...
    def __init__(self, ts_start=None, ts_duration=None, obsv_red_trans_exp=None, red_trans_status=None, ue_ratio=None, confidence=None):  # noqa: E501
        ...
        :param obsv_red_trans_exp: The obsv_red_trans_exp of this RedundantTransmissionExpPerTS.  # noqa: E501
        :type obsv_red_trans_exp: ObservedRedundantTransExp
        :param red_trans_status: The red_trans_status of this RedundantTransmissionExpPerTS.  # noqa: E501
        :type red_trans_status: bool
        ...
        self.openapi_types = {
            'ts_start': datetime,
            'ts_duration': int,
            'obsv_red_trans_exp': ObservedRedundantTransExp,
            'red_trans_status': bool,
            'ue_ratio': int,
            'confidence': int
        }
        ...
        self.attribute_map = {
            ...
            'obsv_red_trans_exp': 'obsvRedTransExp',
            'red_trans_status': 'redTransStatus',
            'ue_ratio': 'ueRatio',
        ...
        self._obsv_red_trans_exp = obsv_red_trans_exp
        self._red_trans_status = red_trans_status
    ...
    @property
    def obsv_red_trans_exp(self):
        """Gets the obsv_red_trans_exp of this RedundantTransmissionExpPerTS.


        :return: The obsv_red_trans_exp of this RedundantTransmissionExpPerTS.
        :rtype: ObservedRedundantTransExp
        """
        return self._obsv_red_trans_exp

    @obsv_red_trans_exp.setter
    def obsv_red_trans_exp(self, obsv_red_trans_exp):
        """Sets the obsv_red_trans_exp of this RedundantTransmissionExpPerTS.


        :param obsv_red_trans_exp: The obsv_red_trans_exp of this RedundantTransmissionExpPerTS.
        :type obsv_red_trans_exp: ObservedRedundantTransExp
        """
        if obsv_red_trans_exp is None:
            raise ValueError("Invalid value for `obsv_red_trans_exp`, must not be `None`")  # noqa: E501

        self._obsv_red_trans_exp = obsv_red_trans_exp

    @property
    def red_trans_status(self):
        """Gets the red_trans_status of this RedundantTransmissionExpPerTS.

        Redundant Transmission Status. Set to \"true\" if redundant transmission was activated, otherwise set to \"false\". Default value is \"false\" if omitted.   # noqa: E501

        :return: The red_trans_status of this RedundantTransmissionExpPerTS.
        :rtype: bool
        """
        return self._red_trans_status

    @red_trans_status.setter
    def red_trans_status(self, red_trans_status):
        """Sets the red_trans_status of this RedundantTransmissionExpPerTS.

        Redundant Transmission Status. Set to \"true\" if redundant transmission was activated, otherwise set to \"false\". Default value is \"false\" if omitted.   # noqa: E501

        :param red_trans_status: The red_trans_status of this RedundantTransmissionExpPerTS.
        :type red_trans_status: bool
        """
